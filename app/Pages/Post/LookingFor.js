...
const LookingFor = () => {
  ...
  const [searchOfText, setSearchOfText] = useState('');
        ...
        <View style={{}}>
          <View style={{flexDirection: 'row', paddingHorizontal: 30}}>
            ...
            <View style={{marginHorizontal: 10}}>
              ...
              <Text style={{fontWeight:'600', paddingHorizontal: 5, fontSize: 17 }}>•</Text>
              <Text style={{fontWeight:'400', fontSize: 17 }}>{'Looking For'}</Text>
              </View>   
          <View>
            ...
            <View style={{marginHorizontal: 30, marginTop: 20}}>
                <View style={{paddingHorizontal: 10, marginTop: 10, backgroundColor: 'black', height: 80, borderRadius: 10}}>
                    <TextInput
                ...
                <View style={{borderWidth: 0.3, borderColor: 'grey', borderRadius: 10, marginTop: 20, paddingHorizontal: 10}}>
                <TextInput
                    style={{fontSize: 20, height: 'auto'}}
                    // onChangeText={onChangeNumber}
                    // value={number}
                    ...
                    multiline={true}
                    value={searchOfText}
                    onChangeText={setSearchOfText}
                ></TextInput>
                </View>
                <View style={{marginTop: 30}}>
                  <TouchableOpacity style={{flexDirection: 'row', gap: 5}} onPress={() => navigation.navigate('Newsfeed')}>
                    <Ionicons size={30} style={{paddingVertical:0, paddingLeft: 8,}} name='location-outline' />
                ...
                {/* <GooglePlacesAutocomplete
                  ...
                  query={{
                    key: 'AIzaSyAWI-obVc6frPPyS8TjKwjnoLMGmNCP9-s',
                    language: 'en',
                  }}
                /> */}
            </View>
