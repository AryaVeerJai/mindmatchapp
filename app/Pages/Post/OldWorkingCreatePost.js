...
// console.log(id, "101")
  ...
  //     let postrImageUrl = selectedMedia.path;
  //     // if (hasCoverImage) {
  //         const postMediaUri = selectedMedia.path;
  //         try {
  //             // Upload image to Firebase Storage
  //             const filename = postMediaUri.substring(postMediaUri.lastIndexOf('/') + 1);
  //             const storageRef = storage().ref(`postimages/${filename}`);
  //             const taskSnapshot = await storageRef.putFile(postMediaUri);
  //             console.log('Upload completed:', taskSnapshot);
  
  //             // Get download URL of the uploaded image
  //             postrImageUrl = await storageRef.getDownloadURL();
  //             console.log('Download URL:', postrImageUrl);
  //         } catch (error) {
  ...
  //     // Get download URL of the uploaded image
  //     const postrImageUrl = await storageRef.getDownloadURL();
  ...
  // Image and Video Picker Library
  ...
  return (
    ...
    <View style={{flex: 1,backgroundColor: '#242527'}} >
      <View style={{backgroundColor: '#333436',flexDirection: 'row', justifyContent: 'space-between', padding:10}}>
        <View><TouchableOpacity><FontAwesomeIcon style={{}} size={35} name='angle-left' /></TouchableOpacity></View>
      ...
      <View style={{flex: 1, paddingVertical: 30, backgroundColor: '#242527', justifyContent: 'space-between'}} >
        <View style={{}}>
          ...
          <View>
            <View style={{display: 'flex', width: 130, backgroundColor: '#333436', borderRadius: 5, paddingHorizontal: 10, paddingTop: 5, paddingBottom: 8, marginTop: 6}}>
              <TouchableOpacity onPress={() => setModalVisible(true)} style={{flexDirection: 'row', display: 'flex' }}>
                <EntypoIcon style={{marginTop: 'auto', marginBottom: 'auto', marginEnd: 10}} name='globe'/>
                <Text style={{fontSize: 12}}>Choose a Pot</Text>
                  ...
                  <View style={[styles.modalContainer,{bottom: 0}]}>
                    <View style={[styles.modalContent,{backgroundColor: '#242527',}]}>
                      ...
                      <View style={{flexDirection: 'row', flexWrap: 'wrap', paddingVertical: 20, columnGap: 30, rowGap: 30, justifyContent: 'center'}}>
                        <View style={{ width: width * 0.27,}}><Image style={{height: 80, borderRadius: 10 ,width: 'auto', marginHorizontal:10}} source={require('../../../profile.webp')}/><Text style={{textAlign: 'center', paddingTop: 7}}>Dance</Text></View>
                        <View style={{ width: width * 0.27,}}><Image style={{height: 80, borderRadius: 10 ,width: 'auto', marginHorizontal:10}} source={require('../../../profile.webp')}/><Text style={{textAlign: 'center', paddingTop: 7}}>DIY</Text></View>
                        <View style={{ width: width * 0.27,}}><Image style={{height: 80, borderRadius: 10 ,width: 'auto', marginHorizontal:10}} source={require('../../../profile.webp')}/><Text style={{textAlign: 'center', paddingTop: 7}}>Social Work</Text></View>
                        <View style={{ width: width * 0.27,}}><Image style={{height: 80, borderRadius: 10 ,width: 'auto', marginHorizontal:10}} source={require('../../../profile.webp')}/><Text style={{textAlign: 'center', paddingTop: 7}}>Mindmatch</Text></View>
                        <View style={{ width: width * 0.27,}}><Image style={{height: 80, borderRadius: 10 ,width: 'auto', marginHorizontal:10}} source={require('../../../profile.webp')}/><Text style={{textAlign: 'center', paddingTop: 7}}>Festival</Text></View>
                        <View style={{ width: width * 0.27,}}><Image style={{height: 80, borderRadius: 10 ,width: 'auto', marginHorizontal:10}} source={require('../../../profile.webp')}/><Text style={{textAlign: 'center', paddingTop: 7}}>Science & Technology</Text></View>
                        <View style={{ width: width * 0.27,}}><Image style={{height: 80, borderRadius: 10 ,width: 'auto', marginHorizontal:10}} source={require('../../../profile.webp')}/><Text style={{textAlign: 'center', paddingTop: 7}}>Painting & Sketching</Text></View>
                        <View style={{ width: width * 0.27,}}><Image style={{height: 80, borderRadius: 10 ,width: 'auto', marginHorizontal:10}} source={require('../../../profile.webp')}/><Text style={{textAlign: 'center', paddingTop: 7}}>Enterpreneurship</Text></View>
                        <View style={{ width: width * 0.27,}}><Image style={{height: 80, borderRadius: 10 ,width: 'auto', marginHorizontal:10}} source={require('../../../profile.webp')}/><Text style={{textAlign: 'center', paddingTop: 7}}>Movies & Theatre</Text></View>
                      </View>
                    </View>
                  </View>
                </Modal>
        ...
        <View style={{marginVertical: 10}}>
          ...
          <View style={{marginBottom: 20, marginTop: 0, marginLeft: 30, }}>
            ...
            <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
              <TouchableOpacity onPress={handlePicker} style={{marginRight: 10, flexDirection: 'row', alignItems: 'center'}}><MaterialCommunityIcons style={{borderRadius: 3, borderStyle: 'dashed', borderWidth: 1.5, borderColor: 'grey', padding:10, marginRight:7 }} size={25} name='plus'/></TouchableOpacity>
