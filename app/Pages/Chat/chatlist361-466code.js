    ...
    return(
        <SafeAreaView style={{flex:1, backgroundColor: 'black'}}>
            ...
            > */}
                ...
                <ScrollView contentContainerStyle={{paddingBottom:80, backgroundColor:'#111828'}}>
                        ...
                        return(
                            ...
                            >
                                ...
                                <View style={{flex:1,paddingLeft:10,paddingRight:15}}>
                                    ...
                                    <Text numberOfLines={1} style={[{color: '#888888'}]}>{data.message ? data.message : 'Lorem ipsum sit amet Lorem ipsum sit amet is the dummy text'}</Text>
                                    {/* <View style={styles.faddingBlock}></View> */}
                                    <LinearGradient
                                        // colors={['rgba(0,0,0,0)', 'black']} // Gradient colors (red to blue)
                                        colors={['rgba(0,0,0,0)', '#111828']} // Gradient colors (red to blue)
